...
public class AppDriver {
	...
	public static String vProject, vProjectURL, vScenarioFile, vTestDataFile, vLocatorFile, vDBName, vDBUserid,
			vDBPassword, vBrowser, vModuleName, vTCName, vKeywords, vResultRes, startexe, stopexe, vDesc;
			...
			if (vRun.equalsIgnoreCase("ON")) {
				...
				if (vBrowser.equals("Chrome")) {
					System.setProperty("webdriver.chrome.driver",
							System.getProperty("user.dir") + "\\src\\Browsers\\chromedriver.exe");
					driver = new ChromeDriver();
				} else if (vBrowser.equals("IE")) {
					System.setProperty("webdriver.ie.driver",
							System.getProperty("user.dir") + "\\src\\Browsers\\IEDriverServer.exe");
